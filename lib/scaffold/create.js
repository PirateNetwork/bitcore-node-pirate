...
var BASE_PACKAGE = {
  description: 'A full Pirate node build with Bitcore',
  repository: 'https://github.com/user/project',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-pirate': 'git+https://git@github.com/piratenetwork/bitcore-lib-pirate#dev-ironwood',
    'bitcore-node-pirate': 'git+https://git@github.com/piratenetwork/bitcore-node-pirate#dev-ironwood'
  }
};

/**
 * Will create a directory and PIRATE.conf file for Pirate.
